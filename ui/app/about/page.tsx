  ...
  return (
    <div className="page-shell about-page">
      ...
      <section className="about-grid">
        ...
        <article><ShieldCheck aria-hidden="true" /><p className="eyebrow">Execution</p><h2>Dedicated private worker</h2><p>The existing V4/V5 worker alone executes confirmed actions and publishes an honest heartbeat for readiness.</p></article>
      </section>
